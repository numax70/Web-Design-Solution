...
function controlloCampi() {
  if (rowcol1.value === "") {
    errore1.innerHTML = "Ops !";
    return;
  } else if (rowcol2.value === "") {
    errore1.innerHTML = '';
    errore2.innerHTML = "Ops !";
    return;
  } else if (rowcol3.value === "") {
    errore2.innerHTML = "";
    errore3.innerHTML = "Ops !";
    return;
  } else if (rowcol4.value === "") {
    errore3.innerHTML = "";
    errore4.innerHTML = "Ops !";
    return;
  } else if (rowcol5.value === "") {
    errore4.innerHTML = "";
    errore5.innerHTML = "Ops !";
    return;
  } else if (rowcol6.value === "") {
    errore5.innerHTML = "";
    errore6.innerHTML = "Ops !";
    return;
  } else if (rowcol7.value === "") {
    errore6.innerHTML = "";
    errore7.innerHTML = "Ops !";
    return;
  } else if (rowcol8.value === "") {
    errore7.innerHTML = "";
    errore8.innerHTML = "Ops !";
    return;
  } else if (rowcol9.value === "") {
    errore8.innerHTML = "";
    errore9.innerHTML = "Ops !";
    return;
  } else if (rowcol10.value === "") {
    errore9.innerHTML = "";
    errore10.innerHTML = "Ops !";
    return;
  } else if (rowcol11.value === "") {
    errore10.innerHTML = "";
    errore11.innerHTML = "Ops !";
    return;
  } else if (rowcol12.value === "") {
    errore11.innerHTML = "";
    errore12.innerHTML = "Ops !";
    return;
  } else if (rowcol13.value === "") {
    errore12.innerHTML = "";
    errore13.innerHTML = "Ops !";
    return;
  } else {
    errore13.innerHTML = "";
